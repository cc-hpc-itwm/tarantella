...
def train_tnt_and_reference_models(model_generator, optimizer, micro_batch_size,
...
class TestsDataParallelOptimizers:
  ...
  def test_optimizers_compare_to_reference(self, model_generator, optimizer, micro_batch_size,
    ...
    tnt_history, ref_history = train_tnt_and_reference_models(model_generator, optimizer,
