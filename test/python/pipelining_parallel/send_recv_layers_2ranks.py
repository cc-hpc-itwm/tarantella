...
class TestPipelineLayers:
  ...
  def test_send_recv_layers_forward(self, test_case):
    ...
    partition_table = {connection_id: ((rank_0, rank_1), tensor_size * micro_batch_size * elem_type.itemsize)}
    pipeline_comm = tnt.PipelineCommunicator(partition_table, num_micro_batches)
